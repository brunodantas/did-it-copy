...
- Every page has the same header, with What, Precedent and History in the navigation and the site name linking to Home.
...
- History page, with a timeline of how copy and paste began, a table of where each system showed the copied content, a table of what each guideline said about Copy and about feedback, and the menu-title lead claim by claim. Every claim has a numbered footnote. The prose is still to come.
