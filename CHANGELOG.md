...
- Stub pages for Precedent and History. Every page has the same header, with What, Precedent and History in the navigation and the site name linking to Home.
...
- Research notes on the copy feedback that ships today in `research/precedent.md`, covering iOS, iPadOS, macOS 26, Windows 10 and 11, ChromeOS, iTerm2, Kitty and WCAG 4.1.3. None of them confirms an ordinary copy. The confirmations that do ship cover special copies such as screenshots, links and images, and WCAG 4.1.3 reaches OS UI through WCAG2ICT.
